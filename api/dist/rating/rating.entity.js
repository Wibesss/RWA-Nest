...
let RatingEntity = exports.RatingEntity = class RatingEntity {
};
__decorate([
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => game_entity_1.GameEntity, (game) => game.ratings),
    __metadata("design:type", game_entity_1.GameEntity)
], RatingEntity.prototype, "game", void 0);
